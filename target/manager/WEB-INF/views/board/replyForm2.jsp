...
<body>
  ...
  <c:if test="${!empty hiBoard }">
    <div class="container">
      ...
      <form name="replyForm" id="replyForm" method="post" enctype="multipart/form-data">
        ...
        <input type="file" name="hiBbsFiles" id="hiBbsFiles" class="form-control mb-2" multiple required>
  ...
  <form name="bbsForm" id="bbsForm" method="post">
      <input type="hidden" id="hiBbsSeq" name="hiBbsSeq" value="${hiBbsSeq}">
