...
<script type="text/javascript">
    $(document).ready(function() {
        $("#btnWrite").on("click", function() {
            ...
            document.bbsForm.action = "/board/writeForm2";
    ...
    function fn_view(hiBbsSeq) {
        document.bbsForm.hiBbsSeq.value = hiBbsSeq;
  ...
  <div class="container">
    <div class="d-flex">
      ...
      <div class="ml-auto input-group" style="width: 50%;">
        ...
        <input type="text" name="_searchValue" id="_searchValue" value="<c:out value="${searchValue}"/>" class="form-control mx-1" maxlength="20" style="width: auto; ime-mode: active;" placeholder="조회값을 입력하세요.">
              ...
              <tr>
                ...
                <td>
                  <a href="javascript:void(0)" onclick="fn_view(${hiBoard.hiBbsSeq})">
                    <c:if test="${hiBoard.hiBbsIndent ne 0}">
                ...
                <td class="text-center"><fmt:formatNumber type="Number" maxFractionDigits="3" groupingUsed="true" value="${hiBoard.hiBbsReadCnt}"/></td>
              </tr>
            </c:forEach>
          </c:when>
          <c:otherwise>
            <tr>
              <td colspan="5" class="text-center">조회 결과가 존재하지 않습니다.</td>
            </tr>
          </c:otherwise>      
        </c:choose>
      </tbody>
